...
export default function Header(){
  ...
  useEffect(() => {
    ...
    return (
      ...
      <Link href="/"><img src="images/logo.png" width="40" style={{display:"inline-block"}} alt="" /></Link>
      ...
      <img src="images/tRBTC.png" alt="" width="25" className='ml-[0.2cm] rounded-[100%] mt-[-0.1cm]' style={{display:"inline-block"}} />
      </div>
      ...
      <Link href="/"><img src="images/logo.png" width="35" alt="" className='float-right' style={{display:"inline-block"}}/></Link>
      </div>) : 
      ...
      <div className='px-[0.5cm]'>
       ...
       <Link href="https://www.rootstock.io/" onClick={(e) => changemenubehaviour2(e)}><img src="images/tRBTC.png" width="32" className='ml-[0.5cm] rounded-[100%]' style={{display:"inline-block"}}/></Link>
       </div>
      </div>
      </div>
      </div>)
